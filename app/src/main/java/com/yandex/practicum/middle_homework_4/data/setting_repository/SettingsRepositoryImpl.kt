    ...
    override suspend fun readSetting() {
        withContext(dispatcher) {
            dataStore.data.collect { preferences ->
                _state.update {
                    SettingContainer(
                        periodic = preferences[REFRESH_PERIOD_KEY] ?: SettingContainer.DEFAULT_REFRESH_PERIOD,
                        delayed = preferences[FIRST_LAUNCH_DELAY_KEY] ?: SettingContainer.FIRST_LAUNCH_DELAY
                    )
                }
            }
        }
